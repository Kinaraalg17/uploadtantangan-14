...
<nav class="navbar navbar-default">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Inpedia Hotel</a>
    </div>
...
<div class="container-fluid bg-1 text-center">
  <h3 class="margin">Inpedia Hotel</h3>
  <img src="painting.png" class="img-responsive img-circle margin" style="display:inline" alt="Bird" width="350" height="350">
  <h3>www.inpediahotel.com</h3>
</div>
<style>
.button {
